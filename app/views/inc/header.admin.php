...
<nav style="background-color: #e3f2fd;"  class="navbar navbar-expand-lg  px-lg-3 py-lg-2 shadow-sm sticky-top ">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
            <a class="nav-link me-2" href="<?= URLROOT ?>/admins/dashboard">dashboard</a>
            </li>
        </ul>
        ...
        <div class="d-flex" >
            <button type="button" class="btn btn-outline-dark shadow-none me-lg-3 me-2"><a class="nav-link me-2" href="<?= URLROOT ?>/admins/login">Login</a></button>
        </div>
